        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-burgundy text-white px-8 py-3 rounded-md hover:bg-burgundy-dark transition-colors font-medium">
                {t('hero.exploreCourses')}
              </button>
              <button className="border-2 border-burgundy text-burgundy px-8 py-3 rounded-md hover:bg-burgundy hover:text-white transition-colors font-medium">
                {t('hero.contactUs')}
              </button>
            </div>
          </div>
